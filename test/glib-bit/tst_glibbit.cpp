...
static guint naive_bit_storage (gulong number);
static guint builtin_bit_storage (gulong number);
static gint naive_bit_nth_lsf (gulong mask, gint nth_bit);
static gint naive_bit_nth_msf (gulong mask, gint nth_bit);
static gint builtin_bit_nth_msf (gulong mask, gint nth_bit);
static gint builtin_bit_nth_lsf1 (gulong mask, gint nth_bit);
static gint builtin_bit_nth_lsf2 (gulong mask, gint nth_bit);

class glibbit : public QObject
{
    Q_OBJECT
...
void glibbit::initTestCase()
{

}

void glibbit::cleanupTestCase()
{
...
QTEST_APPLESS_MAIN(glibbit)

#include "tst_glibbit.moc"
